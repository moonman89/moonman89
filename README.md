...
**Producer / Photographer / Video Director / Co-Founder of Morrowgrid**

I work at the intersection of creative production, visual storytelling, and AI-powered business systems. My work moves between camera, concept, execution, and operations — building visuals that land and systems that keep teams from drowning in scattered work.

---

## Core Identity

I am a creative operator: part director, part producer, part systems builder.

My background is rooted in photography, video direction, commercial production, artist visuals, documentary work, and brand storytelling. Through **Morrowgrid**, I also help businesses organize their operations with AI-assisted workflows, automation, dashboards, outreach systems, and clearer team execution.
...
**Systems:** AI Automation, Workflow Design, Operations Mapping, GitHub, CRM/Task Systems  
...
That means I can help shape the visual idea, organize the production, understand the business goal, and build the system around execution. I care about the final image, but I also care about how the work gets done, delivered, repeated, and scaled.
...
> Build the vision. Systemize the work. Execute clean.